...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls > 0:
        ...
        first_digit, last_digit = opponent_score // 10, opponent_score % 10
        score = max(first_digit, last_digit) + 1
        return score
...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    "*** YOUR CODE HERE ***"
    player1 = score
    player2 = opponent_score
    def update_player1_score(player1, player2):
        player1 = player1 + take_turn(strategy0(player1, player2), player2, select_dice(player1, player2)
        who = other(who)
    def update_player2_score(player1, player2):
        player2 = player2 + take_turn(strategy1(player2, player1), player1, select_dice(player2, player1)
        who = other(who)
    while score <= goal and opponent_score <= goal:
        if score == 0 or opponent_score == 0:
            if who == 0:
                update_player1_score(player1, player2)
            elif who == 1:
                update_player2_score(player1, player2)
